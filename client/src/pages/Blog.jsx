...
const Blog = () => {
  ...
  return data ?  (
    <div className='relative'>
       ...
       alt="" className='absolute -top-0.5 -z-1 opacity-50'
       />
      ...
      <div className='text-center mt-20 text-shadow-gray-600'>
        ...
        <h2 
        className='my-5 max-w-lg truncate mx-auto '>{data.subTitle}</h2>
        <p 
        className='inline-block py-1 px-4 rounded-full mb-6 border text-sm border-primary/35 font-medium text-primary'>
          Michael Brown
        </p>
      </div>
      ...
      <div className='mx-5 max-w-5xl md:mx-auto my-10 mt-6'>
         <img src={data.image} alt="" className='rounded-3xl mb-5' />
           ...
           <div
            className='rich-text max-w-3xl mx-auto' dangerouslySetInnerHTML={{__html: data.description}}>
           </div>
                ...
                <div className='flex flex-col gap-4'>
                  {comments.map((item, index)=>(
                    <div className='relative bg-primary/2 border border-primary/5 max-w-xl p-4 rounded text-gray-600' key={index}>
                       <div className='flex items-center g2 mb-2'>
           ...
           <div className='max-w-3xl mx-auto'>
             ...
             <form onSubmit={addComment} className='flex flex-col items-start gap-4 max-w-lg'>
               ...
               <textarea
                ...
                value={content} placeholder='Comment'
